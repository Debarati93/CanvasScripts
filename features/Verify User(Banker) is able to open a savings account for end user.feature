Feature: Feature to verify User(Banker) is able to open a savings account for end user

Scenario Outline: Verify User(Banker) is able to open a savings account for end user
...
Examples:
      | customer_name | dob     | address  | contact number | govtidnum  | deposit_amount |
      | ABCD          | 19/09/12| Kolkata  | 1234567890     | poiuyxtrewq| 10000          |
