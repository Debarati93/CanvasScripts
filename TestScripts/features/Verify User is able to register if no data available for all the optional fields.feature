Feature: Feature to verify User is able to register if no data available for all the optional fields 

Scenario Outline: Verify User is able to register if no data available for all the optional fields 
...
Examples:
      | firstName | confirmPassword | lastName | userName | phoneNumber | emailID   | password | 
      | ABC       | abc@123	    | DEF      | ABDE     | 1234567890  |abc@xyz.com| asdfg@123| 